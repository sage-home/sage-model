...
SMFsnaps = [63, 48, 40, 32, 27, 23, 20, 18, 16]  # Snapshots to plot the SMF
BHMFsnaps = [63, 48, 40, 32, 27, 23, 20, 18, 16]  # Snapshots to plot the SMF
#SMFsnaps = [49, 41, 38, 32, 23, 17, 13, 10, 8, 7, 5, 4]  # Snapshots to plot the SMF
#BHMFsnaps = [49, 41, 38, 32, 23, 17, 13, 10, 8, 7, 5, 4]  # Snapshots to plot the BHMF
