...
extern "C" {
    ...
    extern void init_galaxy(const int p, const int halonr, int32_t *galaxycounter, const struct halo_data *halos, struct GALAXY *galaxies, const struct params *run_params);
