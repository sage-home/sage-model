                                     ...
                                     struct halo_data *halos)
{
    ...
    XRETURN(buffer != NULL, -MALLOC_FAILURE,
            "Error: Could not allocate memory for %lu halos in the HDF5 buffer. Size requested = %lu bytes\n",
