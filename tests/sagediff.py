...
def compare_catalogs(fname1, num_files_file1, fname2, num_files_file2, mode, ignored_fields=None, multidim_fields=None,
                     rtol=1e-5, atol=1e-9, verbose=False):
    """
...
def compare_binary_hdf5_catalogs(g1, hdf5_file, multidim_fields, rtol=1e-5,
                              atol=1e-9, verbose=False):
    """
...
def compare_binary_catalogs(g1, g2, rtol=1e-5, atol=1e-9, verbose=False):
    """
