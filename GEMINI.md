...
- Use lldb for debugging; input commands from a file (always end with "quit"), e.g. `lldb --batch -s debug_commands.txt ./sage`; use absolute paths for parameter files as lldb changes the working directory
