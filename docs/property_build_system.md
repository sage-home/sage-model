...
**The Key Principle**: Property structures are determined at **build-time**, but module configuration happens at **runtime**.
...
This separation allows for optimal performance while maintaining configuration flexibility.
